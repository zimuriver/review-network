...
function getAdmin(client, userOrg) {
	var keyPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.review.com/users/Admin@%s.review.com/msp/keystore', userOrg, userOrg));
	var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
	var certPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.review.com/users/Admin@%s.review.com/msp/signcerts', userOrg, userOrg));
...
function getUser(client, userOrg, userName) {
	var keyPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.review.com/users/%s@%s.review.com/msp/keystore', userOrg, userName, userOrg));
	var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
	var certPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.review.com/users/%s@%s.review.com/msp/signcerts', userOrg, userName, userOrg));
	var certPEM = readAllFiles(certPath)[0];
...
function getOrdererAdmin(client) {
	var keyPath = path.join(__dirname, Constants.networkLocation + '/crypto-config/ordererOrganizations/review.com/users/Admin@review.com/msp/keystore');
	var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
	var certPath = path.join(__dirname, Constants.networkLocation + '/crypto-config/ordererOrganizations/review.com/users/Admin@review.com/msp/signcerts');
	var certPEM = readAllFiles(certPath)[0];
